...
#ident  "ACI $Id: //depot/sw/releases/olca3.1-Kindle/include/systemtools/ar6003/event.h#1 $, $Header: //depot/sw/releases/olca3.1-Kindle/include/systemtools/ar6003/event.h#1 $"
