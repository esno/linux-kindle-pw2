...
#ifdef CONFIG_LAB126
	struct delayed_work	idle_count;
	struct work_struct	irq_clock_wakeup_work;  /* Enable clock on USB interrupt */
	struct work_struct	enqueue_clock_wakeup_work;  /* Enable clock on urb enqueue */
