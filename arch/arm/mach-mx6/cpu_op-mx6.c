...
#ifdef CONFIG_LAB126
/* This structure defines PLL rates and Core voltages
 * for 1GHz Operation of 6SL processor - this specific
 * change is Bourbon board specific - Jira BOURBON-237
 */
static struct cpu_op mx6sl_cpu_op_1G_Bourbon[] = {
	{
	 .pll_rate = 984000000,
	 .cpu_rate = 984000000,
	 .cpu_podf = 0,
