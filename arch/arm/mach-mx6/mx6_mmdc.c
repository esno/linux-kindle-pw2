...
#if defined (CONFIG_LAB126)
/* LPDDR2 Manufacturer IDs */
const char* lpddr2_mfgids[] = {
        "Reserved", //0000 0000B
        "Samsung", //0000 0001B
        "Qimonda", //0000 0010B
        "Elpida", //0000 0011B
...
#if defined(CONFIG_LAB126)
void display_ddr_mfginfo(void)
{
    char *mfgname = "Reserved";

    if(ddr_mfgid >= ARRAY_SIZE(lpddr2_mfgids)) {
        switch(ddr_mfgid) {
        case 0xFE:
            mfgname = "Numonyx";
            break;
        ...
        default:
            ...
            mfgname = (char *)lpddr2_mfgids[ddr_mfgid];
    }

    /* print always */
    printk(KERN_ERR "LPDDR2 MfgId: 0x%x [%s]\n", ddr_mfgid, mfgname);
}
#endif
